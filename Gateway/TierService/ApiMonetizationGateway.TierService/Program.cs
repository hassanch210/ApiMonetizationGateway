...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "API Monetization Gateway - Tier Service",
        Version = "v1",
        Description = "Tier management service for API Monetization Gateway",
...
// Business services
builder.Services.AddScoped<ITierService, ApiMonetizationGateway.TierService.Services.TierService>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Tier Service API v1");
        c.RoutePrefix = "swagger";
        c.DocumentTitle = "API Monetization Gateway - Tier Service";
